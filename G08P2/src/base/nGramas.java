...
public class nGramas {
	...
	private void crearfrecuenciaMonogramas() {
		...
		for (int i = 0; i < texto.length; i += 2) {
			this.frecuenciaMonogramas.put(texto[i], ((Double.parseDouble(texto[i + 1]) * 100) / total));
		}
	...
	private void crearFrecuenciaQuadragramas() {
		...
		for (int i = 0; i < texto.length; i += 2) {
			...
			this.frecuenciaQuadragramas.put(texto[i], ((Double.parseDouble(texto[i + 1]) * 100) / total));
		}
